...
class Patient extends DomainResource{
    ...
    get identifier(){
        ...
        if(!isValid(this.myIdentifier)){
            ...
            for(let i=0;i<this.myIdentifier.length;i++){
                if(!this.myIdentifier[i] instanceof _IdentifierDt){
                    this.myIdentifier[i]=new _IdentifierDt(this.myIdentifier[i]);
                }
            }
    ...
    get name(){
        ...
        if(!isValid(this.myName)){
            ...
            for(let i=0;i<this.myName.length;i++){
                if(!this.myName[i] instanceof _IdentifierDt){
                    //oVal.push(new IdentifierDt(this.myIdentifier[i]));
                    this.myName[i]=new _HumanNameDt(this.myName[i]);
                }
            }
    ...
    get telecom(){
        ...
        for(let i=0;i<this.myTelecom.length;i++){
            if(!this.myTelecom[i] instanceof _ContactPointDt){
                this.myTelecom[i]=new _ContactPointDt(this.myTelecom[i]);
            }
        }
    ...
    addTelecom(newValue){
        ...
        if(!isValid(newValue)){
            this.telecom.push(new _ContactPointDt());
    ...
    get deceasedBoolean(){
        if(!isValid(this.myDeceasedBoolean)){
            this.myDeceasedBoolean=new _BooleanDt();
        }

        if(!this.myDeceasedBoolean instanceof _BooleanDt){
            this.myDeceasedBoolean=new _BooleanDt(this.myDeceasedBoolean);
        }
...
const _AnimalElement=class AnimalElement extends Object{
    constructor(root){
        super();
    ...
    get species(){
        if(!isValid(this.mySpecies)){
            this.mySpecies=new _CodeableConceptDt();
        }
    ...
    get breed(){
        if(!isValid(this.myBreed)){
            this.myBreed=new _CodeableConceptDt();
        }
    ...
    get genderStatus(){
        if(!isValid(this.myGenderStatus)){
            this.myGenderStatus=new _CodeableConceptDt();
        }
...
const _LinkElement=class LinkElement extends Object{
    constructor(root){
        super();
...
const _ComunicationElement=class ComunicationElement extends Object{
    constructor(){
        super();
    }
...
const PatientResource_AnimalElement=_AnimalElement;
const PatientResource_LinkElement=_LinkElement;
const PatientResource_ComunicationElement=_ComunicationElement;

export { AddressDt, BooleanDt, CodeableConceptDt, CodingDt, ContactPointDt, HumanNameDt, IdentifierDt, NarrativeDt, PeriodDt$1 as PeriodDt, ReferenceDt, PatientResource, PatientResource_AnimalElement, PatientResource_LinkElement, PatientResource_ComunicationElement };
