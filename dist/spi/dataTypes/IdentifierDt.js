...
exports.IdentifierDt = void 0;

var _ValidationRules = require("../utils/ValidationRules.js");

var _FhirDSTUEnums = require("../../../spi/valueSets/FhirDSTUEnums.js");

var _PeriodDt = _interopRequireDefault(require("./PeriodDt.js"));

var _CodeableConceptDt = _interopRequireDefault(require("./CodeableConceptDt.js"));
...
/*#__PURE__*/
function (_Object) {
  _inherits(IdentifierDt, _Object);

  function IdentifierDt(root) {
    var _this;

    _classCallCheck(this, IdentifierDt);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(IdentifierDt).call(this));
    ...
    if ((0, _ValidationRules.isValid)(root)) {
      ...
      _this.assigner = root.assigner;
    }

    return _this;
  }

  _createClass(IdentifierDt, [{
    key: "use",
    get: function get() {
    ...
    get: function get() {
      if (!(0, _ValidationRules.isValid)(this.myType)) {
        this.myType = new _CodeableConceptDt.default();
      }
    ...
    key: "assigner",
    get: function get() {
      if (!(0, _ValidationRules.isValid)(this.myAssigner)) {
...
//# sourceMappingURL=IdentifierDt.js.map