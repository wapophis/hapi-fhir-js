 ...
 * @param {*} root 
 */
class BooleanDt extends Boolean{
...
const AddressDt_=AddressDt;
const BooleanDt_=BooleanDt;
const CodeableConceptDt_=CodeableConceptDt;
const CodingDt_=CodingDt;
const ContactPointDt_=ContactPointDt;
const HumanNameDt_=HumanNameDt;
const IdentifierDt_=IdentifierDt;
const NarrativeDt_=Narrative;
const PeriodDt_=PeriodDt;
const ReferenceDt_=PeriodDt$1;

const PatientResource=Patient;

exports.AddressDt_ = AddressDt_;
exports.BooleanDt_ = BooleanDt_;
exports.CodeableConceptDt_ = CodeableConceptDt_;
exports.CodingDt_ = CodingDt_;
exports.ContactPointDt_ = ContactPointDt_;
exports.HumanNameDt_ = HumanNameDt_;
exports.IdentifierDt_ = IdentifierDt_;
exports.NarrativeDt_ = NarrativeDt_;
exports.PeriodDt_ = PeriodDt_;
exports.ReferenceDt_ = ReferenceDt_;
